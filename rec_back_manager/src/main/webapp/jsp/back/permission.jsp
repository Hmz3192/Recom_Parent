                        ...
                        <shiro:hasAnyRoles name="文章管理员,系统管理员">
                            <li class="panel panel-default dropdown">
                                <a data-toggle="collapse" href="#dropdown-element">
                                    <span class="icon glyphicon glyphicon-list-alt"></span><span
                                        class="title">文章管理</span>
                                </a>
                                <!-- Dropdown level 1 -->
                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    ...
                                    <i style="font-size: 16px">总共有：<em
                                            style="color: red;font-size: 20px">15</em> 条信息</i>
                                </div>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                        ...
                                        <c:forEach var="pe" items="${pe}">
                                            <tr>
                                                <th scope="row">${pe.permissionId}</th>
                                                <td>${pe.permissionName}</td>
                                                <td>${pe.permissionUrl}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a href="#" data-toggle="modal"
                                                                   data-target="#edit">分配角色</a></li>
                                                            <li><a href="#" data-toggle="modal"
                                                                   data-target="#edit">修改信息</a></li>
                                                            <li class="divider"></li>
                                                            <li><a href="#">删除</a></li>
                                                        </ul>
                                                    </div>
