                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            ...
                                                            <li class="divider"></li>
                                                            <li><a href="#" style="color: red">升为会员</a></li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="1" placeholder="3-3">
                </div>
                <div class="form-group">
                    <label for="2">邮箱</label>
                    <input type="password" class="form-control" id="2" placeholder="3@qq.com">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="6" placeholder="我的职业是：科学家,并且我的年龄是：25">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default"
