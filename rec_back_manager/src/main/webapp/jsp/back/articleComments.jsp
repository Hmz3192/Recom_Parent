                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-default btn-sm dropdown-toggle"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#editParent">查看评论
                                                </button>
                                            </td>
                                            <td>2017-05-29 12:00:12</td>
                                            <td>11</td>
                                            <td>3</td>
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="#" style="color: red">不予显示</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel1">查看评论</h4>
            </div>
            <div class="modal-body">
                <span>社交国内产品真能成大气候，月活过三亿的，我估计最终会有四个，微信、QQ、微博、……。过一亿在垂直领域有大成就的，也会有四个左右［不算过三亿］，陌陌、快手基本上会是，还有二个位置</span>
            </div>
...
<div class="modal fade" id="editParent2" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"
                        aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel2">查看评论</h4>
            </div>
            <div class="modal-body">
                <span>直播甚至短视频的最大隐患在于，主流用户的消费习惯尚未形成，一旦受限于用户规模增长停滞，则高流失率带来的后果可想而知</span>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default"
                        data-dismiss="modal">关闭
